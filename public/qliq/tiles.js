            ...
            validateChangesAndComplete = function() {
                ...
                $(el).find('img').each(function() {
                    var img = $(this),
                        ...
                        tileLandscape = tile.width > tile.height,
                        t = img.parent();

                        console.log(width, height, landscape);

                    landscape ? img.attr('class', 'landscape') : img.attr('class', 'portrait');
                    tileLandscape ? t.attr('class','landscape') : t.attr('class', 'portrait');
                });

                console.log(tile.width, tile.height, el);
